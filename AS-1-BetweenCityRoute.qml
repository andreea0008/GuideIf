...
Item {
    ...
    ListModel {
        ...
        ListElement{
            ...
            page: "qrc:/station/AS-1-Gorodenka.qml"
        }
        ListElement{
            title: "Коломийський напрямок"
            page: "qrc:/station/AS-1-Kolomyya.qml"
        }
        ListElement{
            title: "Надвірнянський напрямок"
            page: "qrc:/station/AS-1-Nadvirna.qml"
        }
        ListElement{
            title: "Калуський напрямок"
            page: "qrc:/station/AS-1-Kalush.qml"
        }
        ListElement{
            title: "Рогатинський напрямок"
            page: "qrc:/station/AS-1-Rogatyn.qml"
        }
