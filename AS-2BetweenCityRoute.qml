...
Item {
    ...
    ListModel {
         id: modelPage
         ListElement{
             title: "Галицький напрямок"
             page: "qrc:/station/AS-2-Galych.qml"
         }

         ListElement{
             title: "Калуський напрямок"
             page: "qrc:/station/AS-2-Kalush.qml"
         }
         ListElement{
             title: "Коломийський напрямок"
             page: "qrc:/station/AS-2-Kolomyya.qml"
         }
         ListElement{
             title: "Тернопільський напрямок"
             page: "qrc:/station/AS-2-Ternopil.qml"
         }
    }
